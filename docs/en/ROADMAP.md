...
| 9 MCP tools | code_map, dependency_graph, audit_scan, coverage_map, rtm_parse, rtm_merge, audit_history, fvm_generate, fvm_validate |
| FVM (Functional Verification Matrix) | HTTP-level auth matrix verification — cross-references FE routes × API × BE endpoints × access policies |
