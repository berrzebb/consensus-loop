# evidence-format example (English)

Copy this file to `templates/references/en/evidence-format.md` and adapt it to your project.

This defines the structure of evidence packages submitted to `{{CLAUDE_MD_PATH}}`.
- Adjust the meaning of the 5 required sections (Claim, Changed Files, Test Command, Test Result, Residual Risk)
- Change lint/test commands to match your project tools
