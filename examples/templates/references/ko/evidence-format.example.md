# evidence-format 예제 (한국어)

이 파일을 `templates/references/ko/evidence-format.md`로 복사하고 프로젝트에 맞게 수정하세요.

감사 제출용 증거 패키지 형식입니다. `{{CLAUDE_MD_PATH}}`에 쓰는 내용의 구조를 정의합니다.
- 필수 5칸(Claim, Changed Files, Test Command, Test Result, Residual Risk)의 의미를 조정하세요
- 예시의 lint/test 명령을 프로젝트 도구에 맞게 변경하세요
